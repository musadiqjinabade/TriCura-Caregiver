...
import { StyleSheet, View, Image, SafeAreaView, Text, TouchableOpacity, ActivityIndicator, TextInput,Platform, Alert } from 'react-native';
...
checkInternet() {
    ...
    render() {
        ...
        if (this.state.curloading) {
            ...
            if (this.state.data) {
                mainData = this.state.data[Object.keys(this.state.data)[0]];
                console.log("mainData", this.state.data)
                                    ...
                                    return (
                                        <View>
                                            <View style={[styles.itemRectangleShape, { flexDirection: 'row', marginBottom: wp('1%'), }]}>
                                                ...
                                                {check ? <View style={[commonStyles.center, { justifyContent: 'center', alignItems: 'flex-end', marginRight: wp('3%') }]}
                                                // onPress={() => this.checkTask(data)}
                                                >
