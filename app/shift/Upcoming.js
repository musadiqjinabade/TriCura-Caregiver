...
checkInternet() {
    ...
    async getCurrentData() {
        ...
        var millisecondsMonday = moment(tomorrow).format('X');
        var millisecondsSunday = moment(sevenDate).format('X');
        // console.log("millisecondsMonday:", millisecondsMonday);
        // console.log("millisecondsSunday:", millisecondsMomillisecondsSundaynday);


        var url = Globals.httpMode + agency_code  + Globals.domain + '/api/v1/shifts?start_time='+millisecondsMonday+'&end_time='+millisecondsSunday+'&page=' + this.state.page_no + '&per_page=' + this.state.per_page + '&include_status[]=open,pending,scheduled,attention required';
        console.log("url : ", url);
        ...
        try {
            ...
            try {
                ...
                if (response.status === 200) {
                    // console.log("data : ", response.data.upcoming)
                    if (response.data !== null) {
                        // console.log("data : ", response.data)
                        var responseData = _.map(_.get(response, 'data.upcoming', []), (item) => {
                            return {
                                ...item,
                                mode: 'Collapsed'
                            }
    ...
    async SearchFilterFunction(text) {
        ...
        var millisecondsSunday = moment(sevenDate).format('X');
            ...
            var url = Globals.httpMode + agency_code  + Globals.domain + '/api/v1/shifts?start_time='+millisecondsMonday+'&end_time='+millisecondsSunday+'&page=' + this.state.search_page + '&per_page=' + this.state.per_page + '&name=' + text + '&include_status[]=open,pending,scheduled,attention required';
            console.log("url : ", url);
    ...
    async search_load() {
        ...
        var url = Globals.httpMode + agency_code  + Globals.domain + '/api/v1/shifts?start_time='+millisecondsMonday+'&end_time='+millisecondsSunday+'&page=' + this.state.search_page + '&per_page=' + this.state.per_page + '&name=' + this.state.searchInput + '&include_status[]=open,pending,scheduled,attention required';
        console.log("url loadmore : ", url);
    ...
    async selected_data(item) {
        ...
        var url = Globals.httpMode + agency_code  + Globals.domain + '/api/v1/shifts?start_time='+millisecondsMonday+'&end_time='+millisecondsSunday+'&page=' + this.state.page_no + '&per_page=' + this.state.per_page + '&user_id=' + item.id + '&include_status[]=open,pending,scheduled,attention required';
        console.log("url loadmore : ", url);
